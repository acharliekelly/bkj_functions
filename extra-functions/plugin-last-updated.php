...
NOTE: BKJ Changed functions to begin with bkjf_ namespace
*/

add_filter( 'plugin_row_meta', 'bkj_range_plu_plugin_meta', 10, 2 );

function bkj_range_plu_plugin_meta( $plugin_meta, $plugin_file ) {
	...
	if ( false === $last_updated ) {
		$last_updated = bkjf_range_plu_get_last_updated( $slug );
...
function bkjf_range_plu_get_last_updated( $slug ) {
