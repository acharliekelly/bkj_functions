...
new WPUpdatesPluginUpdater_1831( 'https://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/
if( !class_exists('WPUpdatesPluginUpdater_1831') ) {
	class WPUpdatesPluginUpdater_1831 {
